...
var MainCanvas = {
    ...
    resize : function() {
        var rect = this.canvas_frame.getBoundingClientRect();
        this.canvas.width = Math.max(80, Math.floor(rect.width - this.viewportPaddingX));
        this.canvas.height = Math.max(80, Math.floor(rect.height - this.viewportPaddingY));
    },
